...
async def generate_detailed_report():
    ...
    try:
        ...
        # --- 生成 Markdown 报告 ---
        report_lines = []
        report_lines.append(f"# 灵石经济分析报告 (万圣节活动)")
        report_lines.append(
        ...
        report_lines.append("|:---|:---|")
        report_lines.append(f"| 持有灵石的总用户数 | {total_users_with_coins} |")
        report_lines.append(f"| 灵石总流通量 | {total_coins_in_circulation} |")
