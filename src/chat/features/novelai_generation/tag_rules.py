...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "21. YUEYUE WEIGHT LOCK (MANDATORY): You MUST add weighted tags using correct syntax: green left eye::1.45, blue right eye::1.45, silver hair::1.35, medium breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, heterochromia::1.25. Keep green/blue eye-color tags near the front, but place heterochromia near the back to avoid overriding specific eye colors.\n"
    "22. YUEYUE EARRING LOCK (MANDATORY): Use only `small triangular watermelon earrings` for Yueyue earrings. Do NOT output moon earrings/crescent earrings/crescent moon earrings. Crescent shape belongs to hair stick and necklace only.\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "21. YUEYUE EARRING LOCK (MANDATORY IN REWRITE): Yueyue earrings must be `small triangular watermelon earrings`; do NOT use moon/crescent earrings. Crescent shape is only for hair stick and necklace.\n"
