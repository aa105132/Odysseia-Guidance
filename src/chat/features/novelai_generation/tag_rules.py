...
NOVELAI_TAG_PREFILL_USER = (
    ...
    "- 若请求对象是月月/yueyue/你自己，必须强制保留月月固定DNA标签：1girl, solo, original, green left eye, blue right eye, silver hair, high ponytail, pale skin, small breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, small triangular watermelon earrings, silver crescent moon necklace\n"
    "- 月月权重锁定（正确写法）：green left eye::1.45, blue right eye::1.45, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, heterochromia::1.25；green/blue 瞳色必须前置，heterochromia 必须后置，避免异瞳标签覆盖具体瞳色\n"
    "- 月月罩杯规则：默认 small breasts(B)；仅当用户明确要求更大胸部时，才允许改为 medium breasts/large breasts 等\n"
    "- 月月预填充模板（命中月月时优先放在输出前段）：1girl, solo, original, green left eye::1.45, blue right eye::1.45, silver hair::1.35, high ponytail, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, small breasts::1.25, heterochromia::1.25\n"
...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "19. CRITICAL FOR YUEYUE: If the subject is Yueyue / 月月 / the assistant herself, you MUST include and preserve these exact DNA tags: 1girl, solo, original, green left eye, blue right eye, silver hair, high ponytail, pale skin, small breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, small triangular watermelon earrings, silver crescent moon necklace. Do NOT replace or omit them.\n"
    "20. YUEYUE WEIGHT LOCK (MANDATORY): You MUST add weighted tags using correct syntax: green left eye::1.45, blue right eye::1.45, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, heterochromia::1.25. Keep green/blue eye-color tags near the front, but place heterochromia near the back to avoid overriding specific eye colors.\n"
    ...
    "22. YUEYUE CUP RULE (MANDATORY): Default to small breasts (B cup). Only when user explicitly asks for a bigger bust should you switch to larger cup tags.\n\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "18. CRITICAL FOR YUEYUE REWRITE: If prompt mentions Yueyue/月月/assistant self, you MUST preserve these DNA tags: 1girl, solo, original, green left eye, blue right eye, silver hair, high ponytail, pale skin, small breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, small triangular watermelon earrings, silver crescent moon necklace.\n"
    "19. YUEYUE WEIGHT LOCK (MANDATORY IN REWRITE): Keep/add weighted tags with correct syntax: green left eye::1.45, blue right eye::1.45, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, heterochromia::1.25. Keep green/blue eye-color tags near front and place heterochromia later to reduce color drift.\n"
    ...
    "21. YUEYUE CUP RULE (MANDATORY IN REWRITE): Keep small breasts (B cup) by default. Only when user explicitly requests bigger bust should you rewrite to larger cup tags.\n"
