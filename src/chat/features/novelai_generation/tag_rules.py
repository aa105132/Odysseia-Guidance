...
NOVELAI_TAG_PREFILL_USER = (
    ...
    "- 月月权重锁定（正确写法）：1.45::green left eye, blue right eye::, 1.35::silver hair::, 1.25::medium breasts::, 1.3::silver crescent moon hair stick, silver crescent moon necklace::, 1.45::triangular watermelon earrings::, 1.25::heterochromia::；green/blue 瞳色必须前置，heterochromia 必须后置，避免异瞳标签覆盖具体瞳色\n"
    "- 月月罩杯规则：默认 medium breasts(C)；仅当用户明确要求其他罩杯时，才允许改为 small breasts/large breasts 等\n"
    "- 月月预填充模板（命中月月时优先放在输出前段）：1girl, solo, original, 1.45::green left eye, blue right eye::, 1.35::silver hair::, high ponytail, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, 1.3::silver crescent moon hair stick, silver crescent moon necklace::, 1.45::triangular watermelon earrings::, 1.25::medium breasts::, 1.25::heterochromia::\n"
...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "21. YUEYUE WEIGHT LOCK (MANDATORY): You MUST add weighted tags using correct syntax: 1.45::green left eye, blue right eye::, 1.35::silver hair::, 1.25::medium breasts::, 1.3::silver crescent moon hair stick, silver crescent moon necklace::, 1.45::triangular watermelon earrings::, 1.25::heterochromia::. Keep green/blue eye-color tags near the front, but place heterochromia near the back to avoid overriding specific eye colors.\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "20. YUEYUE WEIGHT LOCK (MANDATORY IN REWRITE): Keep/add weighted tags with correct syntax: 1.45::green left eye, blue right eye::, 1.35::silver hair::, 1.25::medium breasts::, 1.3::silver crescent moon hair stick, silver crescent moon necklace::, 1.45::triangular watermelon earrings::, 1.25::heterochromia::. Keep green/blue eye-color tags near front and place heterochromia later to reduce color drift.\n"
