...
NOVELAI_TAG_PREFILL_USER = (
    ...
    "- 月月权重锁定（正确写法）：green left eye::1.45, blue right eye::1.45, silver hair::1.35, medium breasts::1.25, silver crescent moon hair stick::1.3, triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, heterochromia::1.25；green/blue 瞳色必须前置，heterochromia 必须后置，避免异瞳标签覆盖具体瞳色\n"
    "- 月月罩杯规则：默认 medium breasts(C)；仅当用户明确要求其他罩杯时，才允许改为 small breasts/large breasts 等\n"
    "- 月月预填充模板（命中月月时优先放在输出前段）：1girl, solo, original, green left eye::1.45, blue right eye::1.45, silver hair::1.35, high ponytail, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick::1.3, triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, medium breasts::1.25, heterochromia::1.25\n"
    "- 月月耳坠锁定规则：耳坠只能写 `triangular watermelon earrings`，禁止 `moon earrings` / `crescent earrings` / `crescent moon earrings`；月牙元素只允许在 `silver crescent moon hair stick` 与 `silver crescent moon necklace`\n"
...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "20. CRITICAL FOR YUEYUE: If the subject is Yueyue / 月月 / the assistant herself, you MUST include and preserve these exact DNA tags: 1girl, solo, original, green left eye, blue right eye, silver hair, high ponytail, pale skin, medium breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, triangular watermelon earrings, silver crescent moon necklace. Do NOT replace or omit them.\n"
    "21. YUEYUE WEIGHT LOCK (MANDATORY): You MUST add weighted tags using correct syntax: green left eye::1.45, blue right eye::1.45, silver hair::1.35, medium breasts::1.25, silver crescent moon hair stick::1.3, triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, heterochromia::1.25. Keep green/blue eye-color tags near the front, but place heterochromia near the back to avoid overriding specific eye colors.\n"
    "22. YUEYUE EARRING LOCK (MANDATORY): Use only `triangular watermelon earrings` for Yueyue earrings. Do NOT output moon earrings/crescent earrings/crescent moon earrings. Crescent shape belongs to hair stick and necklace only.\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "20. YUEYUE WEIGHT LOCK (MANDATORY IN REWRITE): Keep/add weighted tags with correct syntax: green left eye::1.45, blue right eye::1.45, silver hair::1.35, medium breasts::1.25, silver crescent moon hair stick::1.3, triangular watermelon earrings::1.45, silver crescent moon necklace::1.3, heterochromia::1.25. Keep green/blue eye-color tags near front and place heterochromia later to reduce color drift.\n"
    "21. YUEYUE EARRING LOCK (MANDATORY IN REWRITE): Yueyue earrings must be `triangular watermelon earrings`; do NOT use moon/crescent earrings. Crescent shape is only for hair stick and necklace.\n"
