...
NOVELAI_TAG_PREFILL_USER = (
    ...
    "- 月月权重锁定（正确写法）：green left eye::1.45, blue right eye::1.45, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.3, silver crescent moon necklace::1.3；眼睛权重标签必须放在前段，且不要给月月追加 heterochromia\n"
...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "20. YUEYUE WEIGHT LOCK (MANDATORY): You MUST add weighted tags using correct syntax: green left eye::1.45, blue right eye::1.45, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.3, silver crescent moon necklace::1.3. Put eye-color weights near the front, keep accessory weights for hair stick/earrings/crescent moon necklace, and do NOT add heterochromia for Yueyue.\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "19. YUEYUE WEIGHT LOCK (MANDATORY IN REWRITE): Keep/add weighted tags with correct syntax: green left eye::1.45, blue right eye::1.45, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.3, silver crescent moon necklace::1.3.\n"
