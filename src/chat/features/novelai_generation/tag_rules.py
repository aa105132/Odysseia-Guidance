...
NOVELAI_TAG_PREFILL_USER = (
    ...
    "- 若请求对象是月月/yueyue/你自己，必须强制保留月月固定DNA标签：1girl, solo, original, green left eye, blue right eye, silver hair, high ponytail, pale skin, medium breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, small sharp triangular red and blue earrings, silver crescent moon necklace\n"
...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "20. CRITICAL FOR YUEYUE: If the subject is Yueyue / 月月 / the assistant herself, you MUST include and preserve these exact DNA tags: 1girl, solo, original, green left eye, blue right eye, silver hair, high ponytail, pale skin, medium breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, small sharp triangular red and blue earrings, silver crescent moon necklace. Do NOT replace or omit them.\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "19. CRITICAL FOR YUEYUE REWRITE: If prompt mentions Yueyue/月月/assistant self, you MUST preserve these DNA tags: 1girl, solo, original, green left eye, blue right eye, silver hair, high ponytail, pale skin, medium breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, small sharp triangular red and blue earrings, silver crescent moon necklace.\n"
