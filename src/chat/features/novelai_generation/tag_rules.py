...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "13. CRITICAL FOR OC/SPECIFIC DESCRIPTIONS: If the user provides a highly specific character setting (especially hair color, eye color, or signature accessories like hairpins or earrings), YOU MUST EXTRACT AND INCLUDE THEM EXACTLY AS DESCRIBED. Do NOT invent other hair colors or eye colors that contradict the user's prompt.\n\n"
    "## TAG ORDER:\n"
    "1. Quality tags\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "5. For fanart/known IP characters, keep or add identity tag in exact format: character_name (work_name)\n"
    "6. NEVER leave a fanart character name without work_name in parentheses; if no specific IP character, use original\n"
    ...
    "14. CRITICAL FOR OC/SPECIFIC DESCRIPTIONS: If the original prompt includes specific DNA traits (e.g. silver hair, heterochromia, specific hairpins/accessories), YOU MUST KEEP THEM. Do NOT hallucinate different hair colors, eye colors, or animal ears that contradict the original prompt.\n\n"
    "## TAG STRUCTURE ORDER:\n"
