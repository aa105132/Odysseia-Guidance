...
NOVELAI_TAG_PREFILL_USER = (
    ...
    "- 若请求对象是月月/yueyue/你自己，必须强制保留月月固定DNA标签：1girl, solo, original, heterochromia, green left eye, blue right eye, silver hair, high ponytail, pale skin, small breasts, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick, small triangular watermelon earrings, silver necklace\n"
    "- 月月权重锁定（正确写法）：(heterochromia:1.35), (green left eye:1.45), (blue right eye:1.45), (silver hair:1.35), (small breasts:1.25), (silver crescent moon hair stick:1.3), (small triangular watermelon earrings:1.3), (silver necklace:1.3)；眼睛权重标签必须放在前段\n"
...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "20. YUEYUE WEIGHT LOCK (MANDATORY): You MUST add weighted tags using correct syntax: (heterochromia:1.35), (green left eye:1.45), (blue right eye:1.45), (silver hair:1.35), (small breasts:1.25), (silver crescent moon hair stick:1.3), (small triangular watermelon earrings:1.3), (silver necklace:1.3). Put eye-color weights near the front, and keep accessory weights for hair stick/earrings/necklace.\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "19. YUEYUE WEIGHT LOCK (MANDATORY IN REWRITE): Keep/add weighted tags with correct syntax: (heterochromia:1.35), (green left eye:1.45), (blue right eye:1.45), (silver hair:1.35), (small breasts:1.25), (silver crescent moon hair stick:1.3), (small triangular watermelon earrings:1.3), (silver necklace:1.3).\n"
