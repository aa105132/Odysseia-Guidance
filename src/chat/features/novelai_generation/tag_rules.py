...
NOVELAI_TAG_PREFILL_USER = (
    ...
    "- 月月权重锁定（正确写法）：green left eye::1.45, blue right eye::1.45, heterochromia::1.25, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.3, silver crescent moon necklace::1.3；眼睛权重标签必须放在前段，且月月必须保留 heterochromia\n"
    "- 月月罩杯规则：默认 small breasts(B)；仅当用户明确要求更大胸部时，才允许改为 medium breasts/large breasts 等\n"
    "- 月月预填充模板（命中月月时优先放在输出前段）：1girl, solo, original, green left eye::1.45, blue right eye::1.45, heterochromia::1.25, silver hair::1.35, high ponytail, fox ears, white fox ears, pink inner ear, fox tail, silver white tail, fluffy tail, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.3, silver crescent moon necklace::1.3, small breasts::1.25\n"
...
AI_TAG_GENERATION_PROMPT_V2 = (
    ...
    "20. YUEYUE WEIGHT LOCK (MANDATORY): You MUST add weighted tags using correct syntax: green left eye::1.45, blue right eye::1.45, heterochromia::1.25, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.3, silver crescent moon necklace::1.3. Put eye-color weights near the front, keep accessory weights for hair stick/earrings/crescent moon necklace, and keep heterochromia for Yueyue.\n"
    ...
    "22. YUEYUE PREFILL PRIORITY (MANDATORY): If subject is Yueyue, begin output with the Yueyue preset block first, then append scene/composition tags.\n"
    "23. YUEYUE SINGLE-CHARACTER STABILITY: Keep 1girl, solo by default. Unless user explicitly requests multi-character composition, do NOT add 2girls/multiple girls/group/another girl/twins/clone-like tags.\n"
    "24. YUEYUE DE-DUP: Avoid duplicated identity/accessory tags; keep one canonical set to reduce prompt drift.\n\n"
    "## TAG ORDER:\n"
    "1. Quality tags\n"
...
AI_REWRITE_PROMPT_V2 = (
    ...
    "19. YUEYUE WEIGHT LOCK (MANDATORY IN REWRITE): Keep/add weighted tags with correct syntax: green left eye::1.45, blue right eye::1.45, heterochromia::1.25, silver hair::1.35, small breasts::1.25, silver crescent moon hair stick::1.3, small triangular watermelon earrings::1.3, silver crescent moon necklace::1.3.\n"
    ...
    "21. YUEYUE SINGLE-CHARACTER STABILITY (MANDATORY IN REWRITE): Keep 1girl, solo by default; unless user explicitly asks multi-character, do NOT add group/2girls/another girl/twins/clone-like tags.\n"
    "22. YUEYUE DE-DUP (MANDATORY IN REWRITE): Deduplicate Yueyue identity/accessory tags and keep one canonical set.\n\n"
    "## TAG STRUCTURE ORDER:\n"
