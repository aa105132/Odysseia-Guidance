    ...
    def build_chat_prompt(
        ...
        if default_image_engine == 'comfyui':
            ...
            comfyui_natural_language_protocol = (
                ...
                'B) 详细度要求：整体写成连续自然语言，建议不少于 8 句，至少覆盖以下维度：\n'
                '   - 风格与成像：艺术/摄影风格、镜头焦段、景别、构图、景深、清晰度与质感；\n'
                '   - 主体细节：年龄段、人种特征、面部结构、肤质、发型发丝、服装材质、道具细节；\n'
                '   - 动作关系：姿态、肢体角度、手部动作（单手单物）、重心与空间关系；\n'
                '   - 场景层次：前景/中景/背景、关键物体位置、环境氛围元素；\n'
                '   - 光影信息：主光方向、色温、强弱、阴影形态、反射光或轮廓光；\n'
                'C) 语言规则：使用主谓宾直述，禁止成语与被动语态，避免空泛形容词；\n'
                'D) 人体约束：动作符合人体工学，不写不可能姿势；\n'
                'E) 安全约束：涉及私密部位暴露时在 prompt 前缀添加 nsfw；\n'
                'F) 负面提示词：negative_prompt 也使用中文自然语言，明确描述需避免的画质/结构问题（如模糊、畸形、错位、低清）。'
            )
