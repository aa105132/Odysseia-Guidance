...
class PromptService:
    ...
    def _build_compact_tool_guidance(self) -> str:
        ...
        lines = [
            ...
            "多人物/多角色时可以继续为每个外部角色分别调用 image_search，全部搜完后用全局编号一次性传入；"
