...
WARMUP_MESSAGES = {
    "consent_prompts": [
        "你在刷群时看到了 **{user_nickname}** 的新帖子。请像真实群友发一条暖贴：只输出1句，尽量控制在20个汉字内；语气要有活人感，可轻度吐槽、玩梗，偶尔用“草”“离谱”“逆天”这类口头表达；可用【大字报】和感叹号强化情绪；优先使用当下中文互联网热门梗；禁止恶意人身攻击、歧视、辱骂家人。"
    ],
    "auto_chat_prompts": [
        "你正在持续关注帖子《{thread_title}》。请基于最近上下文，用月月人设接一句话：只输出1句，尽量控制在20个汉字内；更像活人群友，可轻度吐槽、玩梗，偶尔带“草”“离谱”这类口头表达；可用【大字报】+感叹号表达强烈情绪；优先使用当下中文互联网热门梗；禁止恶意人身攻击、歧视、辱骂家人。",
        "这是社区里的持续讨论串《{thread_title}》。请结合上下文发一条短促接话：只输出1句，尽量控制在20个汉字内；要有活人感，允许轻度吐槽和玩梗；情绪强时可用【大字报】、叠字、感叹号；优先使用当下中文互联网热门梗；禁止恶意人身攻击、歧视、辱骂家人。"
    ],
    "idle_call_prompts": [
        "帖子《{thread_title}》已经冷场（约 {idle_minutes} 分钟）。请用月月人设发一条召回消息：只输出1句，尽量控制在20个汉字内；语气像活人群友，可轻度吐槽、玩梗，情绪强时可用【大字报】和感叹号；优先用当下中文互联网热门梗；{target_hint}；禁止恶意人身攻击、歧视、辱骂家人。",
        "帖子《{thread_title}》好久没人说话了（约 {idle_minutes} 分钟）。请写一条有情绪的召回短句：只输出1句，尽量控制在20个汉字内；允许轻度吐槽和玩梗，必要时可“开大”用【大字报】表达情绪；优先使用当下中文互联网热门梗；{target_hint}；禁止恶意人身攻击、歧视、辱骂家人。"
    ],
    "consent_dm": (
